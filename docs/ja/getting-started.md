...
[Prism.SourceGenerators.Samples](https://github.com/MvvmAIO/Prism.SourceGenerators.Samples)
...
<ItemGroup>
  ...
  <PackageReference Include="MvvmAIO.Prism.Bcl.Commands" Version="0.2.0" />
</ItemGroup>
```
