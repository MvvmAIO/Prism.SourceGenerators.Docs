...
| **Prism 9** | Uses in-box async command types; **Navigation / Region / Dialog** generator demos. |
...
Clone the repo and open the solution there to debug **ObservableProperty**, **commands**, **registration**, **region navigation**, and **dialogs** end-to-end.
...
- **`Prism.SourceGenerators.Samples.Prism9`** — targets **`net10.0`**, Prism 9 with in-box async commands; includes **Validation**, **region navigation**, and a **confirm dialog** demo.
