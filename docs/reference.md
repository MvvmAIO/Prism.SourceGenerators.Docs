...
| **[GitHub — Prism.SourceGenerators.Docs](https://github.com/MvvmAIO/Prism.SourceGenerators.Docs)** | This documentation site (Markdown, VitePress, publishing workflow). |
...
| Topic | Page |
|-------|------|
| Generator topics | [Generators](/generators/) |
| **PSG** diagnostics | [Diagnostics reference](/diagnostics/reference) |
| CI and local build | [Build & CI](/build-and-ci) |
...
The product **README** files (English / 简体中文 / 日本語) and the **[GitHub Wiki](https://github.com/MvvmAIO/Prism.SourceGenerators/wiki)** are **brief entry points**. **[About this site](/about-this-site)** explains how they relate to **this site**, which remains the **canonical manual**.
